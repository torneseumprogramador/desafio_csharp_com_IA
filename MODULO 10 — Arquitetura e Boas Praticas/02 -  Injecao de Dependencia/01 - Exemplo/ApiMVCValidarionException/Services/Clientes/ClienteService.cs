...
public class ClienteService : IClienteService
{
    ...
    private readonly IClienteValidationService _validationService;
    private readonly IMapper _mapper;

    public ClienteService(IClienteRepository repository, IClienteValidationService validationService, IMapper mapper)
    {
    ...
    {
        _validationService.ValidatePatchRequest(request);
