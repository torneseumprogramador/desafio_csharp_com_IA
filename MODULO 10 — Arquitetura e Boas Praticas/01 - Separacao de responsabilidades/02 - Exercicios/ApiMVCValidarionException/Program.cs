...
builder.Services.AddScoped<IClienteValidationService, ClienteValidationService>();
builder.Services.AddScoped<IProdutoValidationService, ProdutoValidationService>();
