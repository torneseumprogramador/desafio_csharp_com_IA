...
public class MemoryClienteRepository : IClienteRepository
{
    ...
    public MemoryClienteRepository()
    {
        _clientes =
        [
            new Cliente { Id = 1, Nome = "Ana Souza", Email = "ana@email.com", Telefone = "11999990001", Cpf = new Cpf("12345678901") },
            new Cliente { Id = 2, Nome = "Bruno Lima", Email = "bruno@email.com", Telefone = "11999990002", Cpf = new Cpf("12345678902") }
        ];
